...
import com.dengmingjie.qrcodedemo.R;
import com.dengmingjie.qrcodedemo.ResultActivity;
			...
			switch (requestCode) {
				case REQUEST_CODE:
                    ...
                    if (!TextUtils.isEmpty(uri.getAuthority())) {
                        ...
                        photoPath = intent.getData().getPath();
                    }
	...
	public void onClick(View v) {
		...
		case R.id.capture_scan_photo: // 图片识别
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                innerIntent = new Intent(Intent.ACTION_PICK); // "android.intent.action.PICK"
            } else {
                innerIntent = new Intent(Intent.ACTION_GET_CONTENT); // "android.intent.action.GET_CONTENT"
            }
